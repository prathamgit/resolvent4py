...
def setup(lin_op: 'LinearOperator', u: SLEPc.BV, dt: PETSc.ScalarType, method: TimeSteppingScheme = 'RK4'):
    r"""
...
def timestep(lin_op: 'LinearOperator', u: SLEPc.BV, f: Optional[Union[SLEPc.BV, Tuple[SLEPc.BV, SLEPc.BV]]] = None,
