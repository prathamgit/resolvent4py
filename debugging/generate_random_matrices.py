...
comm = MPI.COMM_WORLD
nrows, ncols = 5,5
sizes = ((lin.compute_local_size(nrows),nrows),\
         (lin.compute_local_size(ncols),ncols))
# lin.generate_random_petsc_sparse_matrix(comm, sizes)
lin.generate_random_petsc_vector(comm, sizes[0])
